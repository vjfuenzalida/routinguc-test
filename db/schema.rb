...
ActiveRecord::Schema.define(version: 2019_02_26_154747) do
  ...
  create_table "driver_cities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["city_id"], name: "index_driver_cities_on_city_id"
    t.index ["driver_id"], name: "index_driver_cities_on_driver_id"
  end
  ...
  add_foreign_key "driver_cities", "cities"
  add_foreign_key "driver_cities", "drivers"
